...
#define		UCSR0A_RXC			__port(UCSR0A).bit7
#define		UCSR0A_TXC			__port(UCSR0A).bit6
#define		UCSR0A_UDRE			__port(UCSR0A).bit5
#define		UCSR0A_FE 			__port(UCSR0A).bit4
#define		UCSR0A_DOR			__port(UCSR0A).bit3
#define		UCSR0A_UPE			__port(UCSR0A).bit2
#define		UCSR0A_U2X			__port(UCSR0A).bit1
#define		UCSR0A_MPCM			__port(UCSR0A).bit0
...
#define		ADCSRA_ADFR			__port(ADCSRA).bit5
